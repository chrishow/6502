export class InstructionDecoder {
    static opcodes = [
        ...
        /* 0 */  [ ['BRK', 'IMPL'], ['ORA', '#'   ], [null, null], [null, null], [null , null   ], ['ORA', 'ZPG'  ], ['ASL', 'ZPG'  ], [null, null], ['PHP', 'IMPL'], ['ORA', '#'   ], ['ASL', 'A'   ], [null, null], [null, null   ], ['ORA', 'ABS' ], ['ASL', 'ABS' ], [null, null] ],
        ...
        /* 2 */  [ ['JSR', 'ABS' ], ['AND', 'XIND'], [null, null], [null, null], ['BIT', 'ZPG'  ], ['AND', 'ZPG'  ], ['ROL', 'ZPG'  ], [null, null], ['PLP', 'IMPL'], ['AND', '#'   ], ['ROL', 'A'   ], [null, null], ['BIT', 'ABS' ], ['AND', 'ABS' ], ['ROL', 'ABS' ], [null, null] ],
        ...
        /* 4 */	 [ ['RTI', 'IMPL'], ['EOR', 'XIND'], [null, null], [null, null], [null, null    ], ['EOR', 'ZPG'  ], ['LSR', 'ZPG'  ], [null, null], ['PHA', 'IMPL'], ['EOR', '#'   ], ['LSR', 'A'   ], [null, null], ['JMP', 'ABS' ], ['EOR', 'ABS' ], ['LSR', 'ABS' ], [null, null] ],
        ...
        /* 6 */	 [ ['RTS', 'IMPL'], ['ADC', 'XIND'], [null, null], [null, null], [null, null    ], ['ADC', 'ZPG'  ], ['ROR', 'ZPG'  ], [null, null], ['PLA', 'IMPL'], ['ADC', '#'   ], ['ROR', 'A'   ], [null, null], ['JMP', 'ind' ], ['ADC', 'ABS' ], ['ROR', 'ABS' ], [null, null] ],
        ...
        /* 9 */	 [ ['BCC', 'REL' ], ['STA', 'INDY'], [null, null], [null, null], ['STY', 'ZPGX' ], ['STA', 'ZPGX' ], ['STX', 'ZPG,Y'], [null, null], ['TYA', 'IMPL'], ['STA', 'ABSY'], ['TXS', 'IMPL'], [null, null], [null, null   ], ['STA', 'ABSX'], [null, null   ], [null, null] ],
        ...
        /* B */	 [ ['BCS', 'REL' ], ['LDA', 'INDY'], [null, null], [null, null], ['LDY', 'ZPGX' ], ['LDA', 'ZPGX' ], ['LDX', 'ZPG,Y'], [null, null], ['CLV', 'IMPL'], ['LDA', 'ABSY'], ['TSX', 'IMPL'], [null, null], ['LDY', 'ABSX'], ['LDA', 'ABSX'], ['LDX', 'ABSY'], [null, null] ],
